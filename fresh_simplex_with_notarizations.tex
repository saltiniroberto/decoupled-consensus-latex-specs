...
Over any non-finality period of length $T \geq 1$ on the canonical chain, the total penalty increment across all validators assessed by $\textsf{processInactivityPenalties}$ is at least $(T - 1) \cdot n/3$.
\end{theorem}
